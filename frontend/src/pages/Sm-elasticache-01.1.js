        ...
        await Axios.get(`${api_url}/api/aws/region/elasticache/cluster/nodes/`,{
                    ...
                    if (data.data.ReplicationGroups.length> 0) {
                            ...
                            if( rg['ClusterEnabled'] == true ){
                                ...
                                clusterEndpoint = rg.ConfigurationEndpoint;
                                                                ...
                                                                */}
                                                                ...
                                                                <table style={{"width":"100%"}}>
                                                                    <tr>  
                                                                        ...
                                                                        <td style={{"width":"12.5%", "border-left": "2px solid red", "padding-left": "1em"}}>  
                                                                            <CompMetric01 
                                                                                value={dataMetrics.keyspaceMisses}
                                                                        ...
                                                                        <td style={{"width":"12.5%", "border-left": "2px solid red", "padding-left": "1em"}}>  
                                                                            <CompMetric01 
                                                                                value={ (  (dataMetrics.keyspaceHits / ( dataMetrics.keyspaceHits + dataMetrics.keyspaceMisses) ) * 100 ) || 0}
                                                                                title={"CacheHitRate (%)"}
                                                                                precision={2}
                                                                                format={1}
                                                                                fontColorValue={"#F6CE55"}
                                                                        ...
                                                                        <td style={{"width":"12.5%", "border-left": "2px solid red", "padding-left": "1em"}}>  
                                                                            <CompMetric01 
                                                                                value={dataMetrics.totalConnectionsReceived}
                                                              ...
                                                              <table style={{"width":"100%"}}>
                                                                  <tr>  
                                                                    <td style={{"width":"30%","padding-left": "1em"}}> 
                                                                            ...
                                                                            timestamp={dataMetrics.timestamp} title={"Operations/sec"} height="230px" />
                                                                    </td>
                                                                    ...
                                                                    <td style={{"width":"30%","padding-left": "1em"}}> 
                                                                            <ChartLine02 series={[
                                                                             ...
                                                                             timestamp={dataMetrics.timestamp} title={"Latency Call(us)"} height="230px" />
                                                                    </td>
                                                                    <td style={{"width":"30%","padding-left": "1em"}}> 
                                                                            <ChartLine02 series={[
